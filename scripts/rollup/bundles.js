...
const bundleTypes = {
  ...
  UMD_TESTING_DEV: 'UMD_TESTING_DEV',
  UMD_TESTING_PROD: 'UMD_TESTING_PROD',
  NODE_DEV: 'NODE_DEV',
  NODE_PROD: 'NODE_PROD',
  NODE_PROFILING: 'NODE_PROFILING',
  NODE_TESTING_DEV: 'NODE_TESTING_DEV',
  NODE_TESTING_PROD: 'NODE_TESTING_PROD',
  FB_WWW_DEV: 'FB_WWW_DEV',
  FB_WWW_PROD: 'FB_WWW_PROD',
  FB_WWW_PROFILING: 'FB_WWW_PROFILING',
  FB_WWW_TESTING_DEV: 'FB_WWW_TESTING_DEV',
  FB_WWW_TESTING_PROD: 'FB_WWW_TESTING_PROD',
  RN_OSS_DEV: 'RN_OSS_DEV',
  RN_OSS_PROD: 'RN_OSS_PROD',
  RN_OSS_PROFILING: 'RN_OSS_PROFILING',
  RN_OSS_TESTING_DEV: 'RN_OSS_TESTING_DEV',
  RN_OSS_TESTING_PROD: 'RN_OSS_TESTING_PROD',
  RN_FB_DEV: 'RN_FB_DEV',
  RN_FB_PROD: 'RN_FB_PROD',
  RN_FB_PROFILING: 'RN_FB_PROFILING',
  RN_FB_TESTING_DEV: 'RN_FB_TESTING_DEV',
  RN_FB_TESTING_PROD: 'RN_FB_TESTING_PROD',
};
...
const bundles = [
  ...
  {
    bundleTypes: [NODE_DEV, NODE_PROD, NODE_TESTING_DEV, NODE_TESTING_PROD],
    moduleType: NON_FIBER_RENDERER,
  ...
  /******* React Reconciler *******/
  {
    bundleTypes: [
      NODE_DEV,
      NODE_PROD,
      // NODE_TESTING_DEV, NODE_TESTING_PROD
    ],
